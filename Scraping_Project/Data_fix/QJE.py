...
# Save to a new file
df.to_excel("/Users/zachklopping/Desktop/GitHub/JL_Summer_25/Scraping Project/Data_fix/Combined Data/QJE_2000-2025.xlsx", index=False)

print(f"Saved {len(df)} articles to 'QJE_2000_2025.xlsx'.")
