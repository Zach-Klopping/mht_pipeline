...
input_folder = '/Users/zachklopping/Desktop/List 25/Paper Outputs/raw_table_chunk/batch_6'
output_folder = "/Users/zachklopping/Desktop/List 25/Paper Outputs/table_output/batch_6"
model = "gpt-4.1"
temperature = 0.1  # keep it deterministic
max_tokens = 10000  # output cap, tweak as needed

# === CUSTOM PROMPT ===
system_prompt = "You are an assistant helping a researcher identify treatment effects from paper extracts."
user_prompt_intro = """
Here is the extracted output from a series of academic papers. Read the entire text. Only use what is written—do not speculate or infer beyond the provided text.
