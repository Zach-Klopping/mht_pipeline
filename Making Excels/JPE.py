...
# ISSN for Journal of Political Economy (JPE)
issn = "0022-3808"
...
for year in range(start_year, end_year + 1):
    ...
    while True:
        ...
        # Retry with exponential backoff on throttling/transient errors
        ...
        page += 1
        start_idx += count
        # no fixed sleep here; only backoff on errors

# ----------------------------
# Save results
# ----------------------------
out_dir = "/Users/zachklopping/Desktop/John List/MHT/Raw Excels"
os.makedirs(out_dir, exist_ok=True)
out_path = os.path.join(out_dir, "JPE_2000-2025.xlsx")

df = pd.DataFrame(articles)
df.to_excel(out_path, index=False, engine="openpyxl")  # ensure engine available
